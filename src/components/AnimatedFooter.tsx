...
// Safe fallback for useTheme when next-themes is optional
...
export function AnimatedFooter({
  ...
  const { resolvedTheme } = useThemeFallback();
  ...
  return (
    <footer
      ref={rootRef}
      className={cn(
        "relative h-[60vh] sm:h-[70vh] lg:h-[80vh] min-h-[450px] w-full overflow-hidden flex flex-col justify-end bg-black text-white",
      ...
      <div className="absolute inset-x-0 bottom-0 flex items-end justify-center gap-4 p-8">
        {headingLines.map((word, wi) => (
          <h2
            ...
            style={{ fontSize: "clamp(2rem, 13cqw, 11rem)", fontFamily: "'Outfit', sans-serif" }}
          >
